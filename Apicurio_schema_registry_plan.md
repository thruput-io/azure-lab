...
Two separate files, both generated by `entra_app.tf` and stored in Key Vault. Neither is hand-edited or mutated by scripts.
...
The "Download client.properties" GitHub Action delivers **both** files as separate artifacts.
...
- Before starting each new step, re-read this file and `project_guidelines.md` to stay on track.
